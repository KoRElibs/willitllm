...
dev/
  SPEC.md                    — this file
  update_models_prompt.md    — scraper workflow instructions (AI-readable)
...
| top-right | Model | `<select id="modelSelect">` | Models grouped by organization (with flag emoji), sorted alphabetically within each group |
...
`dev/update_models_prompt.md`) when new models need to be added.
